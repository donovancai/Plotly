...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var  holdSample= data.samples;
    // 4. Create a variable that filters the samples for the object with the desired sample number.
    var resultArray2 = holdSample.filter(sampleObj => sampleObj.id == sample);
...
//Bubble charts
    ...
    var  holdwfreq= data.metadata;
    // 4. Create a variable that filters the samples for the object with the desired sample number.
    var resultArray = holdwfreq.filter(sampleObj => sampleObj.id == sample);
